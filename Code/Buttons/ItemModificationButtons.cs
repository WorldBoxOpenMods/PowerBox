...
namespace PowerBox.Code.Buttons {
  public class ItemModificationButtons : ButtonFeature {
    internal override List<Type> RequiredFeatures => base.RequiredFeatures.Concat(new []{ typeof(GodPowers.ItemAdditionPower), typeof(GodPowers.ItemRemovalPower), typeof(EditItemsWindow) }).ToList();
