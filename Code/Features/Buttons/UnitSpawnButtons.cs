...
namespace PowerBox.Code.Features.Buttons {
  public class UnitSpawnButtons : ButtonFeature {
    internal override FeatureRequirementList RequiredFeatures => base.RequiredFeatures.Concat(new []{ typeof(UnitSpawnPowers) }).ToList();
    internal override FeatureRequirementList OptionalFeatures => new List<Type>{ typeof(DebugMenuButton) };
